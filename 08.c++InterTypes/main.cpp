...
int main() {
  ...
  std::cout << "Domesticated animal count : " << domesticated_animals <<
  std::endl;
  */
  ...
  std::cout << "Narrowing conversion : " << narrowing_conversion_functional <<
  std::endl;
  */
  ...
  std::cout << "Narrowing conversion : " << narrowing_conversion_assignment
            << std::endl;
