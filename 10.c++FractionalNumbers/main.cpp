...
int main() {
  ...
  //Print out the sizes of the variables
  ...
  std::cout << "number is : " << number1 << std::endl; // 7 digits precision
  ...
  //for a ot of (float)(192400016.0F)
  double number4 {192400023.0};  //Error : narrowing coversion
  ...
  //is fixed notation. There is another notation, sceintific
  //that is hand if you have really huge numbers or small numbers
  //to represent
  ...
  double number7 (1.923e8);             // Can ommit the lower 00023 for simplicity if our application alows to handle
